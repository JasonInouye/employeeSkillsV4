		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee Skills V4",
									"targetURL": "#employeeSkillsV4empskillsv4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employeeSkillsV4empskillsv4-display": {
								"semanticObject": "employeeSkillsV4empskillsv4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeeSkillsV4.empskillsv4",
									"url": sap.ui.require.toUrl("employeeSkillsV4/empskillsv4")
								}
							}
						}
					}
